...
class DepositMoneyController(BaseController):
    ...
    def enter(self, *args, **kwargs) -> int:
        ...
        self.handler(account_number, account_name, account_password, account_currencyType, deposit_amount)
    ...
    def handler(self, account_number: int, account_name: str, account_password: str, account_currencyType: CurrencyType,
        ...
        try:
            ...
            account_number = self.deposit_money(account_number, account_name, account_password, account_currencyType, deposit_amount)
            print_message(msg=f'\nYour Have deposited money into your account: {account_number}')
        except Exception as e:
            print_error(f'Deposit money failed: {str(e)}')

    @staticmethod
    def deposit_money(account_number: int, account_name: str, account_password: str, account_currencyType: CurrencyType,
